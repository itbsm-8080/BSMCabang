object frmBayarCustomer: TfrmBayarCustomer
  Left = 217
  Top = 157
  Width = 1024
  Height = 575
  Caption = 'Pembayaran Customer'
  Color = clBtnFace
  ...
  object PANEL: TAdvPanel
    ...
    object cxLookupCustomer: TcxExtLookupComboBox
      ...
      Properties.OnEditValueChanged = cxLookupcustomerPropertiesEditValueChanged
    ...
    object dtTglCair: TDateTimePicker
      Left = 703
      Top = 162
      Width = 140
      Height = 21
    ...
    object cxLookupRekeningTransfer: TcxExtLookupComboBox
      Left = 129
      Top = 74
      Enabled = False
      Properties.ImmediatePost = True
    ...
    object edtNilaiTransfer: TAdvEdit
      Left = 701
      Top = 74
      Width = 141
      Height = 21
    ...
    object chkPotongan: TCheckBox
      ...
      Caption = 'Potongan'
      TabOrder = 8
      OnClick = chkPotonganClick
    end
    object cxLookupRekeningPotongan: TcxExtLookupComboBox
      Left = 129
      Top = 96
      Enabled = False
      Properties.ImmediatePost = True
    ...
    object chkGiro: TCheckBox
      ...
      Caption = 'Giro'
      TabOrder = 11
      OnClick = chkGiroClick
    end
    object cxLookupRekeningGiro: TcxExtLookupComboBox
      Left = 130
      Top = 118
      Enabled = False
      Properties.ImmediatePost = True
    ...
    object cxLookupRekPPN: TcxExtLookupComboBox
      Left = 129
      Top = 140
      Enabled = False
      Properties.ImmediatePost = True
    ...
    object cxLookupRekeningPPH: TcxExtLookupComboBox
      Left = 129
      Top = 162
      Enabled = False
      Properties.ImmediatePost = True
    ...
    object edtNilaiPotongan: TAdvEdit
      Left = 702
      Top = 96
      Width = 141
      Height = 21
  ...
  object AdvPanel4: TAdvPanel
    ...
    object cxGrid: TcxGrid
      ...
      object cxGrdMain: TcxGridDBTableView
        ...
        object clJthTempo: TcxGridDBColumn
          Caption = 'Jatuh Tempo'
          DataBinding.FieldName = 'JthTempo'
          PropertiesClassName = 'TcxDateEditProperties'
          Properties.ReadOnly = True
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
        ...
        object clKontrak: TcxGridDBColumn
        ...
        object clTerbayar: TcxGridDBColumn
        ...
        object clBayar: TcxGridDBColumn
          DataBinding.FieldName = 'Bayar'
          PropertiesClassName = 'TcxCurrencyEditProperties'
          Properties.Alignment.Horz = taRightJustify
          Properties.DisplayFormat = ',0.00;(,0.00)'
          Properties.ReadOnly = False
          Properties.OnEditValueChanged = clBayarPropertiesEditValueChanged
          Properties.OnValidate = clBayarPropertiesValidate
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
          Width = 113
        end
