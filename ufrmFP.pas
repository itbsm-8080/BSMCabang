...
//  tt.SaveToFile('s.txt');
     try
        ...
        if ProcedureExists(frmMenu.conn, 'sp_update_do_hdr') then
     begin

            s:='CALL sp_update_do_hdr('+quot(edtNomorDO.Text)+');';
...
var
  ...
  afeemarketing,afeemarketing2 : Double;
begin
  result:=true;
   i := 1;
...
//----------------------
       ...
       anetharga := anetharga - abiayapromosi - abiayapromosi2 - afeemarketing - afeemarketing2;
