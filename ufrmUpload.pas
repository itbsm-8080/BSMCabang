...
+ ' and overdue > 60 and salesman not in  ("INTERNAL","SEWA","KONTRAK"));';
 ...
 // CUSTOMER
  ...
  //      xExecQuery(ss,frmMenu.conn2);
      ...
      s:='SELECT jurd_jur_no,jurd_rek_kode,jurd_debet,jurd_kredit,jurd_nourut, jurd_cc_kode,jurd_keterangan,jurd_nopol,jurd_cus_kode,jurd_ekspedisi, jurd_kilometer '
      ...
      begin
        ...
        begin
          ...
          + ' jurd_jur_no,jurd_rek_kode,jurd_debet,jurd_kredit,jurd_nourut,jurd_keterangan,jurd_cc_kode,jurd_nopol,jurd_cus_kode,jurd_ekspedisi,jurd_kilometer '
          + ' ) values ('
          + Quot(Fields[0].AsString) +','
          + Quot(Fields[1].Asstring) +','
          + FloatToStr(Fields[2].AsFloat) +','
